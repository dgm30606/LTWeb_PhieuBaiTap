...
```
1. type="email" → Ô nhập text, tự kiểm tra có @ → Dùng cho form đăng ký
2. type="password" → Ô nhập text, ký tự hiện thành chấm tròn che đi mật khẩu → Dùng cho form đăng ký
3. type="date" → Chọn ngày tháng năm → Dùng cho form đăng ký
4. type="radio" → Chỉ chọn 1 các radio có cùng name → Dùng cho form đăng ký
5. type="checkbox" → Chọn các ô mình muốn → Dùng cho form đăng ký
6. type="color" → Chọn màu → Dùng cho form đăng ký
7. type="number" → Ô nhập số vào text, có 2 nút tăng giảm → Dùng cho form đăng ký
8. type="month" → Chọn tháng năm → Dùng cho form đăng ký
9. type="search" → Ô nhập text, sẽ có nút xóa ở cuối → Dùng cho tìm kiếm thông tin
10. type="button" → Là một nút
